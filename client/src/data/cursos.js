export const cursos = [
    {
        ...
        slug: "ai-sdk",
        descripcion: "Aprende a integrar IA en aplicaciones web con el AI SDK de Vercel. Streaming, useChat, RAG, embeddings y patrones de UI para chatbots.",
        duracion: "8h",
        nivel: "Intermedio",
    ...
    },
    {
        ...
        descripcion: "Aprende a usar Gemini CLI desde la terminal. Perfecto para quienes inician con IA y quieren productividad sin código complejo.",
        duracion: "6h",
        nivel: "Principiante",
    ...
    },
    {
        ...
        descripcion: "Domina Claude Code para productividad extrema. Aprende técnicas avanzadas, hooks, MCP servers y automatización de workflows.",
        duracion: "2h",
        nivel: "Avanzado",
        imagen: "https://anthropic.gallerycdn.vsassets.io/extensions/anthropic/claude-code/1.0.85/1755637900866/Microsoft.VisualStudio.Services.Icons.Default",
        precio: 499,
    ...
    },
    {
        ...
        descripcion: "Aprende los fundamentos de desarrollo web full-stack con React Router v7. Sin Redux, con velocidad optimizada.",
        duracion: "1h",
        nivel: "Principiante",
    ...
    },
    {
        ...
        descripcion: "Crea animaciones profesionales para tu portafolio. 14 componentes listos para usar con Framer Motion.",
        duracion: "10h",
        nivel: "Intermedio",
    ...
    },
    {
        ...
        descripcion: "Crea un clon de ChatGPT desde cero usando Node.js y la API de OpenAI. Streaming, contexto y más.",
        duracion: "1h",
        nivel: "Intermedio",
...
export const getCursosByTag = (tag) => cursos.filter((c) => c.tags.includes(tag));
