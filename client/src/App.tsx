...
// Tabs para alternar entre Console y Preview
function SandpackTabs({
  activeTab,
  onTabChange,
}: {
  ...
  return (
    <div className="flex items-center gap-1 px-2 py-1.5 bg-slate-800/50 border-b border-slate-700">
      <button
